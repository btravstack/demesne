// Copy the core package's TypeDoc-generated Markdown (its `docs/` output) into the
// VitePress site under `api/core/`, so the API reference ships with the guide.
//
